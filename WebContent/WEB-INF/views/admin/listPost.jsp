                                    ...
                                    <div>
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="hidden-480">CategoryID</th>
										...
										<tbody>
                                                <tr>
                                                    ...
                                                    <td class="hidden-480"><a href="${pageContext.request.contextPath}/postDetail?code=${post.postID}">${post.getTitle()}</a> </td>
                                                     <td class="center">
                                                      
                                                            <p><img class="hidden-480" src="./Images/${post.getImage()}" alt="images" width="70" height="70"></p>
												...
												<td class="hidden-480">
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="green" href="editPost?postID=${post.postID}">
                                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                            </a>

                                                            <a class="red" href="deletePost?postID=${post.postID}">
                                                        ...
                                                        <div class="hidden-md hidden-lg">
                                                            <div class="inline pos-rel">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                        <a href="editPost?postID=${post.postID}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                            <span class="green">
                                                                    ...
                                                                    <li>
                                                                        <a href="deletePost?postID=${post.postID}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                            <span class="red">
