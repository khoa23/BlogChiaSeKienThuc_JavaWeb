...
%>
	<body class="no-skin">
                                        ...
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Post ID</th>
                                                    <th>Post Title</th>
                                                    <th class="hidden-480">Post Category</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Learn CSS</td>
                                                    <td class="hidden-480">Front end </td>
                                                    <td>Feb 12</td>

                                                    <td class="hidden-480">
                                                        <span class="label label-sm label-warning">6.500</span>
                                                    </td>

                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="green" href="editPost.html">
		...
		<script src="${pageContext.request.contextPath}/assets/js/dataTables.tableTools.min.js"></script>
		<script src="${pageContext.request.contextPath}/assets/js/dataTables.colVis.min.js"></script>
