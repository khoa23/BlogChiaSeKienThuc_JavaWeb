        ...
        <div class="row">
           <div class="col-xs-12">
                ...
                <hr>
                 ...
                 <form class="form-horizontal" role="form"  method="POST" action="${pageContext.request.contextPath}/postAdd" enctype="multipart/form-data">
...
<!-- content  -->    <div class="form-group ">
                        ...
                        <div class="col-sm-4">
                         <td>
                                <textarea class="form-textarea" id="content" name="content" value="${post.content}"></textarea>
