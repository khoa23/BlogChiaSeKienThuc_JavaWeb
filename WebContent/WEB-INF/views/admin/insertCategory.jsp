				        ...
				        <div class="row">
				           <div class="col-xs-12">
				                ...
				                <hr>
				                 ...
				                 <form class="form-horizontal"  method="POST" action="${pageContext.request.contextPath}/categoryAdd" >
				                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" > Category Name </label>
				
											<div class="col-sm-9">
												<input name="categoryname" class="col-xs-10 col-sm-5" placeholder="name" type="text" value="${category.categoryName}">
